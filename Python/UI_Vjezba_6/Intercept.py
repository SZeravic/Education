...
def gameLoop():
	...
	while not gameExit:
		...
		udaljenost_desno = pow((lead_x - (lead_x_2+pomak)), 2) + pow((lead_y - lead_y_2), 2)
		udaljenost_gore = pow((lead_x - (lead_x_2)), 2) + pow((lead_y - (lead_y_2+pomak)), 2)
		udaljenost_dolje = pow((lead_x - (lead_x_2)), 2) + pow((lead_y - (lead_y_2-pomak)), 2)
		
		#print('Udaljenost lijevo: ', udaljenost_lijevo)
		#print('Udaljenost desno: ', udaljenost_desno)
		#print('Udaljenost gore: ', udaljenost_gore)
		#print('Udaljenost dolje: ', udaljenost_dolje)
		...
		if ( (udaljenost_desno <= udaljenost_lijevo) & (udaljenost_desno <= udaljenost_dolje) & (udaljenost_desno <= udaljenost_gore) ):
			#print('Idemo desno!')
			lead_x_2 = lead_x_2+pomak2
		if ( (udaljenost_gore < udaljenost_dolje) ):
			#print('Idemo gore!')
			lead_y_2 = lead_y_2+pomak2
		if ( (udaljenost_dolje < udaljenost_gore) ):
                        #print('Idemo gore!')
			lead_y_2 = lead_y_2-pomak2
		# NADOPISATI OSTALE OPCIJE
