...
export default () => (
    ...
    <main className="items">
        ...
        <p className="small-paragraph">Gotovo polovica radnih mjesta popunjava se putem preporuka i kontakata.
        ...
        <h2 className="main-title">Poslali ste životopis? Lijepo ... To nije dovoljno.</h2>
        <p className="small-paragraph">Kada bi traženje posla putem Interneta bilo tako jednostavno, svi bi ljudi imali posao.
        ...
        <h2 className="main-title">Znate li što želite?</h2>
        <p className="small-paragraph">Ako nemate cilj, svi putevi vode u krivom smjeru. Morate imati jasnu ideju onoga što želite. Jednom kada to znate moći ćete se koncentrirati upravo na one stvari koje vas uistinu zanimaju.
        ...
        <h2 className="main-title">Uspostavite kontakt</h2>
        <p className="small-paragraph">Ako zaista želite posao, nemojte samo poslati prijavu i nadati se najboljem. Kontaktirajte poslodavca koji je objavio oglas i razgovarajte izravno s njim.
